...
public class MediumLengthFlowerFactory implements AbstractFlowerFactory {
    private static final int length = 10;

    private static final float rosePrice = 16;
    private static final float chamomilePrice = 12;
    private static final boolean spike = false;
    private static final int petals = 20;
    private static final int freshness = 9;
